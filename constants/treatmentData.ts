...
export const adultTreatments: AdultTreatmentOptions = {
  ...
  pathway2: { // Alternative: SABA reliever + other controller(s)
    1: { 
      ...
      keyPoints: ["For patients with infrequent symptoms (less than twice a month) AND no exacerbation risk factors.", "Reduces risk of severe exacerbations compared to SABA-only treatment."],
...
export const youngChildTreatments: YoungChildTreatmentOptions = {
  ...
  2: {
    ...
    preferred: {
      ...
      keyPoints: ["Indicated if wheezing episodes are frequent (3 or more per year) or there are interval symptoms.", "Most effective option for reducing symptoms and exacerbations."],
