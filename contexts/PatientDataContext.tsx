...
export const PatientDataProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
 ...
 useEffect(() => {
  ...
  newResults.type2Inflammation = parseInt(biomarkers.bloodEosinophils) greater than or equal to 150 || 
                  parseInt(biomarkers.feNo)greater than 25 ||
                  parseInt(biomarkers.sputumEosinophils) greater than or equal to 2 ||
  ...
  newResults.eligibleForBiologics = newResults.severeAsthma && 
                   ...
                   parseInt(basicInfo.exacerbationsLastYear) greater than or equal to 1;
