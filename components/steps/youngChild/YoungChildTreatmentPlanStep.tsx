...
const YoungChildTreatmentPlanStep: React.FC = () => {
 ...
 const canStepUp = youngChild_currentGinaSteplower than 3; // Step 4 is referral only
 const canStepDown = youngChild_currentGinaStepgreater than 1;
  ...
  <Card title="Treatment Plan (Young Child ≤5 years)" icon={<Baby className="text-violet-600" />}>
   ...
   {activeTreatment ? (
    <div className="space-y-3 bg-white p-4 rounded-md border border-slate-200">
     ...
     {activeTreatment.keyPoints && activeTreatment.keyPoints.lengthgreater than 0 && (
   ...
   {currentStepDetails?.alternatives && currentStepDetails.alternatives.lengthgreater than 0 && youngChild_currentGinaStep lower than or equal to 2 && (
