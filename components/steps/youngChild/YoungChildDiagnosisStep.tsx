...
const diagnosisCriteriaList = [
  { 
    ...
    details: "History of ≥2 wheezing episodes in the past year, OR 1 episode with asthma-like symptoms in between."
  },
  { 
...
const YoungChildDiagnosisStep: React.FC = () => {
 ...
 const handleDetermineDiagnosis = () => {
  ...
  } else if (metCriteriaCount greater than or equal to 1) {
   // Suspected Asthma
