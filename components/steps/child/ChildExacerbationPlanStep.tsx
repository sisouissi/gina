...
import { AlertTriangle, CheckCircle, ChevronRight, FileText, RotateCcw, Activity, ShieldAlert } from 'lucide-react';
    ...
    >
      ...
      <div className="mt-8 pt-6 border-t border-slate-200 space-y-3">
        <p className="text-xs text-slate-500 text-center">
            Ensure parents have an up-to-date written asthma action plan for their child and understand when and how to act.
        </p>
        <Button 
