            ...
            <AssessmentCard title="Asthma Control Assessment" icon={<Stethoscope />}>
                <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <Checkbox label={'Exacerbations: 2 or more per year requiring OCS OR 1 or more per year requiring hospitalization'} checked={severeAsthma.symptoms.frequentExacerbations} onChange={(e: any) => updateSevereAsthmaData('symptoms', 'frequentExacerbations', e.target.checked)} />
